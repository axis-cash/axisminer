...
#
# Testscript to test axisminer multiple pools/hosts/syntaxes
# Put this script in the bin directory of axisminer and start running
#
...
# export some vars as "./axisminer" could be still a wrapper script
...
for pool in $POOLS; do
    ...
    echo "./axisminer -v 1 --exit --report-hashrate -P $pool $@"
    echo "./axisminer -v 1 --exit --report-hashrate -P $pool $@" > log.txt
    ./axisminer -v 1 --exit --report-hashrate -P $pool $@ >> log.txt 2>&1 &
    pid=$!
    #echo "PID=$pid"
